...
armlink --scatter scatter_mmu.txt --entry Vectors -o image_A9.axf ./obj/startup.o ./obj/main.o ./obj/primes.o ./obj/retarget.o ./obj/A9MP_SCU.o ./obj/A9MP_GIC.o ./obj/A9MP_Mutexes.o ./obj/v7.o
