...
armlink --scatter scatter_mmu.txt --entry Vectors -o image_A5.axf ./obj/startup.o ./obj/main.o ./obj/retarget.o ./obj/primes.o ./obj/A5MP_SCU.o ./obj/A5MP_GIC.o ./obj/A5MP_Mutexes.o ./obj/v7.o
